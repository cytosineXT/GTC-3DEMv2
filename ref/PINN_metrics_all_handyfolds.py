...
def main():
    ...
    output_base_dir = increment_path(f'output/PINNmetrics/{datetime.today().strftime("%m%d")}_DDoutput_folds_logHelm_', exist_ok=False)
    ...
    subfolders_to_process = [
        '/home/jiangxiaotian/workspace/GTC3DEM_DD/output/distillate_v9.2simu/0605_v9.2_b100_lr0.001_σ5.0_cpu_%0.1122_snap0_e200_2_dd_Td/distilled_dataset/DDEMparamsRCS',
        '/home/jiangxiaotian/workspace/GTC3DEM_DD/output/distillate_v9.2simu/0607_v9.2_b100_lr1.0_σ5.0_cpu_%0.1122_snap0_e200_dd_Td/distilled_dataset/DDEMparamsRCS',
        '/home/jiangxiaotian/workspace/GTC3DEM_DD/output/distillate_v9.2simu/0609_v9.2_b100_lr1.0_σ5.0_cpu_%0.1122_snap-1_e200_Dd940_Td/distilled_dataset/DDEMparamsRCS',
        '/home/jiangxiaotian/workspace/GTC3DEM_DD/output/distillate_v9.2/0609_v9.2_b100_lr1.0_σ5.0_cpu_%0.1122_snap-1_e200_Dd940/distilled_dataset/DDEMparamsRCS'
        ]
    ...
    for folder_path in tqdm(subfolders_to_process, desc="处理数据子文件夹", ncols=100):
        folder_name = folder_path.split('/')[-3]  # 获取文件夹名称
